...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/08ce248aaf52b51b0004e9740b7ef538', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/08ce248aaf52b51b0004e9740b7ef538',undefined,undefined)
	                      ...
	                      "children": [
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.starName}
	                              }
	                            },
	                            {
	                              "type": "div",
	                              "repeat": function () {return this.starNum},
	                              "style": {
	                                "marginTop": 20
	                              },
	                              "children": [
	                                {
	                                  "type": "image",
	                                  "attr": {
	                                    "src": function () {return this.$value}
	                                  },
	                                  "style": {
	                                    "width": 30,
	                                    "height": 30,
	                        ...
	                        },
	                        {
	                          ...
	                          "children": [
	                            {
	                              "type": "div",
	                              "repeat": function () {return this.keyWords},
	                              "style": {
	                                "marginRight": 30
	                              },
	                              "children": [
	...
	module.exports = {
	    ...
	    methods: {
	        onappear: function onappear(e) {
	            console.log('cell显示=' + e.target.attr.index);
	        },
	        ondisapper: function ondisapper(e) {
	            console.log('cell不显示=' + e.target.attr.index);
	        },
	        oncellclick: function oncellclick(e) {
	            console.log('你点击了cell' + e.target.attr.index);
	        },
	        appandData: function appandData(callback) {
	            var stream = __weex_require__('@weex-module/stream');
	            var me = this;
	            var GET_URL = 'http://ejlian.cn/interface/home/list';
	            ...
	            stream.fetch({
	                ...
	                if (!ret.ok) {
	                    console.log('不好意思,请求失败了!');
	                } else {
	                    for (var i = 0; i < ret.data.data.length; i++) {
	                        var item = ret.data.data[i];
	                        var tempArray = [];
	                        for (var j = 0; j < 5; j++) {
	                            if (j < Number(item.starNum)) {
	                                tempArray.push('/images/ic_star_normal.png');
	                            } else {
	                                tempArray.push('/images/ic_star_select.png');
	                            }
	                        }
	                        item.starNum = tempArray;
	                        me.getResult.push(item);
	                    }
	                    console.log('me.getResult===' + me.getResult);
	                }
	                callback();
	            }, function (response) {
	        ...
	        onrefresh: function onrefresh(e) {
	            ...
	            self.getResult.splice(0, self.getResult.length);
	            self.appandData(function () {
